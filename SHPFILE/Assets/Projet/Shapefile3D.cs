...
namespace Assets.PipelineGenerator.Scripts.ESRI.ShapeImporter3D
{
    ...
    public enum ShapeType
    {
        ...
        // beginRTS
        /// <summary>
        /// A triplet of double-precision coordinates in the order X, Y, Z plus a measure
        /// </summary>
        PointZ = 11,
        // endRTS
    ...
    public class ShapeFileHeader
    {
        ...
        public override string ToString()
        {
            ...
            // beginRTS
            sb.AppendFormat(
                "ShapeFileHeader: FileCode={0}, FileLength={1}, Version={2}, ShapeType={3}, xMin={4}, xMax={5}, yMin={6}, yMax={7}, zMin={8} zMax={9}",
                this.fileCode, this.fileLength, this.version, this.shapeType, this.xMin, this.xMax, this.yMin,
                this.yMax, this.zMin, this.zMax);
            // endRTS
        ...
        // beginRTS
        public System.Collections.Generic.List<double> GetMinMax()
        {
    ...
    public class ShapeFile
    {
        ...
        public ShapeFileRecord ReadShapeFileRecord(Stream stream)
        {
            ...
            switch (record.ShapeType)
            {
                ...
                case (int) ShapeType.PointZ:
                    ShapeFile.ReadPointZ(stream, record);
                    break;
                // endRTS
                default:
                {
        ...
        // beginRTS
        /// <summary>
        /// Read a shapefile PointZ record.
        /// </summary>
        /// <param name="stream">Input stream.</param>
        /// <param name="record">Shapefile record to be updated.</param>
        private static void ReadPointZ(Stream stream, ShapeFileRecord record)
        {
            // Points - add a single point.
            //,double XMax,double XMin,double YMax,double YMin
            Vector3 p = new Vector3();
            ...
            double measure = ShapeFile.ReadDouble64_LE(stream);
